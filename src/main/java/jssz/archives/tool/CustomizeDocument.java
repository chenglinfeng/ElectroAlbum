...
public class CustomizeDocument extends XWPFDocument {
	public CustomizeDocument(InputStream in) throws IOException {
		super(in);
	}
	...
	public CustomizeDocument(OPCPackage pkg) throws IOException {
		super(pkg);
	}
